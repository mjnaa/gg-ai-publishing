/* 드롭다운메뉴 / 단일선택메뉴
  - 루트: [class="dd-choice"]
  - 토글 버튼: [class="dd-choice-toggle"]
  - 리스트: [class="dd-choice-list"]
  - 항목 버튼: [class="dd-choice-item"]
    · .active → 현재 선택된 항목
  - 옵션: [data-choice="llm"] → LLM 서비스 선택용 드롭다운
    · 선택 시 .page-text.llm-XX 요소를 찾아 5초간 안내문구 노출
  - 기능: 
    · 토글 버튼 클릭으로 열기/닫기
    · 항목 선택 시 .active 토글 및 타이틀(.dd-title)에 반영
    · 외부 클릭/ESC 시 닫기
    · LLM 선택 시 안내문 자동 표시
*/
